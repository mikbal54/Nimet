...
bool DotSceneLoader::parseDotScene(const std::wstring &SceneName, const Ogre::String &groupName, Ogre::SceneManager *yourSceneMgr, Ogre::SceneNode *pAttachNode, const Ogre::String &sPrependNode)
{
    ...
    {
      Ogre::LogManager::getSingleton().logMessage( "[DotSceneLoader] Error: Invalid .scene File. Missing <scene>" , Ogre::LogMessageLevel::LML_CRITICAL);
        return false;
    }
