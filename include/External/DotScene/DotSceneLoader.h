...
#include "rapidxml.hpp"
    ...
    public:
        ...
        bool parseDotScene(const std::wstring &SceneName, const Ogre::String &groupName, Ogre::SceneManager *yourSceneMgr, Ogre::SceneNode *pAttachNode = NULL, const Ogre::String &sPrependNode = "");
